...
tier_s_distribution = [
    #name_id["Cursed Shld"],
    (name_id["Marvel Shoes"],   0.14),
    (name_id["Gem Box"],        0.12),
    (name_id["Economizer"],     0,12),
    (name_id["ValiantKnife"],   0.10),
    (name_id["Fixed Dice"],     0.10),
    (name_id["Offering"],       0.10),
    (name_id["Exp. Egg"],       0.08),
    (name_id["Ragnarok"],       0.07),
    (name_id["Snow Muffler"],   0.05),
    (name_id["Minerva"],        0.05),
