...
class Animations:
    ...
    def remove_battle_flashes_mod(self):
        ...
        # For each battle animation command addresses that's associated with a background flash
        for animation_cmd_addr in battle_animation_scripts.BATTLE_ANIMATION_FLASHES:
